 ...
 * supplied — and in the legacy class's line-item arithmetic
 * (handled in `invoices/simplified-debit-note.ts`).
 *
 * `name="0200000"` is the BR-KSA-06 subtype literal for simplified
 * tax invoice / debit note family.
 *
 * Do not reformat.
 */
...
/**
 * Fills the simplified debit note template with values from `input`.
 *
